...
class SplitService(
    ...
    fun createWorkoutDay(
        splitId: Long,
        request: WorkoutDayRequest,
        userId: Long,
    ): WorkoutDayResponse {
        ownershipResolver.getOwnedSplit(splitId, userId)
        val saved =
            workoutDayRepository.save(
    ...
    fun updateWorkoutDay(
        workoutDayId: Long,
        request: WorkoutDayPatchRequest,
        userId: Long,
    ): WorkoutDayResponse {
    ...
    fun createTemplateExercise(
        ...
        val saved =
            templateExerciseRepository.save(
                TemplateExercise(
    ...
    fun updateTemplateExercise(
        ...
        request: TemplateExercisePatchRequest,
        userId: Long,
    ): TemplateExerciseResponse {
    ...
    fun updateTemplateSet(
        templateSetId: Long,
        request: TemplateSetPatchRequest,
        userId: Long,
    ): TemplateSetResponse {
    ...
    private fun copyTemplateExercisesAndSets(
        ...
        val newExercises =
            templateExerciseRepository.saveAll(
                sourceExercises.map {
                    TemplateExercise(
    ...
    private fun WorkoutDay.toResponse(templateExercises: List<TemplateExerciseResponse>) =
        WorkoutDayResponse(
            workoutDayId = workoutDayId,
            name = name,
            sortOrder = sortOrder,
    ...
    private fun TemplateExercise.toResponse(templateSets: List<TemplateSetResponse>) =
        TemplateExerciseResponse(
    ...
    private fun TemplateSet.toResponse() =
        TemplateSetResponse(
